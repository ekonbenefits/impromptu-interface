...
namespace ImpromptuInterface.Build
{
    ...
    public static class BuildProxy
    {
     ...
     emitInfo.ResolveReturnType, emitInfo.ResolvedIndexParamTypes);
        ...
        private static Type DefineCallsiteFieldForMethod(this TypeBuilder builder, AssemblyMaker maker, string name, Type returnType, IEnumerable<Type> argTypes, MethodInfo info)
        {
        ...
        private static Type DefineCallsiteField(this TypeBuilder builder, AssemblyMaker maker, string name, Type returnType, params Type[] argTypes)
        {
